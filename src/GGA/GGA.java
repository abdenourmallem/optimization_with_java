...
public class GGA {
    ...
    public static CandidateGGA generateIndividual(MKP mkp, List<Pairs> x1, double ir, double[] pb) {
        int[] remainingCapacities = Arrays.copyOf(mkp.capacities, mkp.numConstraints);
        ...
        CandidateGGA candidate = new CandidateGGA(mkp, chr);
        return candidate;
    }

    public static CandidateGGA[] createPopulation(MKP mkp, int ps, double ir, double[] pb, List<Pairs> gp) {
        CandidateGGA[] population = new CandidateGGA[ps];
        for (int i = 0; i < ps; i++) {
    ...
    public static double[] populationFitness(CandidateGGA[] population, MKP mkp) {
    ...
    public static double[] populationObjVal(CandidateGGA[] population, MKP mkp) {
    ...
    public static CandidateGGA[] concat(CandidateGGA[] a, CandidateGGA[] b) {
        CandidateGGA[] result = new CandidateGGA[a.length + b.length];
        System.arraycopy(a, 0, result, 0, a.length);
        System.arraycopy(b, 0, result, a.length, b.length);
        return result;
    }

    public static CandidateGGA[] reproductionMethod(MKP mkp, CandidateGGA[] population, double ir, double[] pb,
            List<Pairs> gp) {
        ...
        CandidateGGA[] newPopulation = new CandidateGGA[bestCHromSize];
    ...
    public static List<Integer> localSearchMethod(MKP mkp, List<Pairs> x1, CandidateGGA candidate, qAgent agent,
        ...
        CandidateGGA clone = new CandidateGGA(mkp, chromosome);
        int startIdx = 0;
    ...
    public static CandidateGGA[] selection(MKP mkp, CandidateGGA[] population, int nbk) {
        Random rand = new Random();
        CandidateGGA[] new_population = new CandidateGGA[population.length];
    ...
    public static CandidateGGA[] crossover(MKP mkp, CandidateGGA parent1, CandidateGGA parent2, double pc) {
        ...
        if (rand.nextDouble() < pc) {
            ...
            CandidateGGA childCandidate1 = new CandidateGGA(mkp, child1);
            CandidateGGA childCandidate2 = new CandidateGGA(mkp, child2);
            return new CandidateGGA[] { childCandidate1, childCandidate2 };
        } else {
            return new CandidateGGA[] { parent1, parent2 };
        }

    }

    public static List<Integer> mutation(MKP mkp, List<Pairs> x1, double ir, double[] pb, CandidateGGA individual,
            int nmp,
            double pm) {
        Random rand = new Random();
        Set<Integer> prev = new HashSet<>();
        CandidateGGA pos = new CandidateGGA(mkp, individual.chromosome);
        for (int i = 0; i < nmp; i++) {
    ...
    public static CandidateGGA executeGGA(MKP mkp, double ir, int NG, int PS, double PC, double PM,
            double r1r2) {
        int ps = 500;
        int ng = 200;
        double pc = PC;
        ...
        CandidateGGA[] population = createPopulation(mkp, ps, r2, pb, GuideParts.get(0));
        ...
        CandidateGGA besCandidate = new CandidateGGA(mkp, population[bestCandIdx].chromosome);
        ...
        for (int gen = 0; gen < ng; gen++) {
            ...
            CandidateGGA[] selected = selection(mkp, population, nbk);

            List<CandidateGGA> newPopulationList = new ArrayList<>();
            for (int i = 0; i < selected.length; i += 2) {
                // perform crossover operator

                CandidateGGA[] children = crossover(mkp, selected[i], selected[i + 1], pc);
            ...
            population = newPopulationList.toArray(new CandidateGGA[0]);
                ...
                for (String k : l2) {
                    for (int z : l3) {
                        ...
                        for (int ite = 0; ite < 30; ite++) {
                            ...
                            CandidateGGA can = executeGGA(mkp, 0.9, 200, 500, 0.7, 0.2, 0.4);
    ...
    public static void qScriptSac() {
        ...
        List<ResultBatchSac> allResults = new ArrayList<>();
        int n = 0;
        int nReps = 30;
                ...
                for (double pm1 : pm) {
                    for (double r1 : r1r2) {
                        for (int i = 0; i < or.length; i++) {
                            ...
                            System.out.println("optimum : " + opt);
                            long t1 = System.nanoTime();
                            CandidateGGA can = executeGGA(mkp, irr, 200, 500, pc1, pm1,
                                    r1);
                            double exec = (System.nanoTime() - t1) / 1000000000.0;
    ...
    public static double retrainingData(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            System.out.println("optimum : " + opt);
            long t1 = System.nanoTime();
            CandidateGGA can = executeGGA(mkp, ir, ng, ps, pc, pm,
                    r1r2);
            double exec = (System.nanoTime() - t1) / 1000000000.0;
            double score = (can.calcObjValCromosome(mkp.profits) / opt) * 100;
            scores.add((int) score);
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < nReps; i++) {
            ...
            CandidateGGA bestSol = executeGGA(mkp, 0.9, 200, 500, 0.7, 0.2, 0.4);
